...
function RenderCashFlowStatementRow({ data, padding, getTotalAmount }) {
    ...
    <SectionLoader condition={!data}>
      <tr>
        ...
        >
          ...
          <Link
            to={`/pages/reports/account-transactions?duration=${duration}&chart_of_account_id=${data?.id}`}
          >
            {data.name}
          </Link>
        </td>
...
RenderCashFlowStatementRow.propTypes = {
  data: PropTypes.object,
  padding: PropTypes.number.isRequired,
  getTotalAmount: PropTypes.func.isRequired,
};

RenderCashFlowStatementRow.defaultProps = {
  data: {},
};
export default RenderCashFlowStatementRow;
